...
<div class="two-col">
    ...
    <div class="col screenshot-image">
        <span><?php esc_html_e('Active Theme', 'homepress'); ?></span>
        <img src="<?php echo esc_url(get_template_directory_uri()) . '/screenshot.png'; ?>" alt="<?php esc_attr_e('Screenshot', 'homepress'); ?>"/>
    </div>
</div>