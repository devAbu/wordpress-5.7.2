                                ...
                                <?php else: ?>
                                    ...
                                    <?php foreach ($listing_type_form as $key => $form) :
                                        ...
                                        if ($index == 0) {
                                            ...
                                            $form_content .= '<div data-v-if="category_selected.type_selected == ' . $key . '" class="advanced-search-button col-xl-3 col-lg-3 col-md-3 col-sm-12" data-v-bind_class="{open:categories[' . $category->term_id . '].advanced_panel_show}"
