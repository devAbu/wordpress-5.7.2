            ...
            new Vue({
                ...
                methods: {
                    ...
                    saveSettings: function(id) {
                        var vm = this;
                        vm.loading = true;
                        this.$http.post(stmt_to_ajaxurl + '?action=stmt_save_settings&security=' + window.homepress_data.stmt_save_settings + '&name=' + id, JSON.stringify(vm.data)).then(function(response){
                            vm.loading = false;
                        });
                    }
                }
