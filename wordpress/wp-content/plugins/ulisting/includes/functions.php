...
function ulisting_subscription_active()
{
    ...
    return in_array('ulisting-subscription/ulisting-subscription.php', $active_plugins);
}
...
{
    $active_plugins = get_option('active_plugins');
    return in_array('ulisting-wishlist/ulisting-wishlist.php', $active_plugins) && !empty(get_option('uListing_wishlist_loaded'));
}

function uListing_exporter_active() {
    $active_plugins = get_option('active_plugins');
    return in_array('ulisting-exporter/ulisting-exporter.php', $active_plugins) && !empty(get_option('uListing_wishlist_loaded'));
}
...
{
    $active_plugins = get_option('active_plugins');
    return in_array('ulisting-compare/ulisting-compare.php', $active_plugins) && !empty(get_option('uListing_compare_loaded'));
}
...
{
    $active_plugins = get_option('active_plugins');
    return in_array('ulisting-user-role/ulisting-user-role.php', $active_plugins);
}
...
{
    $active_plugins = get_option('active_plugins');
    return in_array('ulisting-social-login/ulisting-social-login.php', $active_plugins);
}
