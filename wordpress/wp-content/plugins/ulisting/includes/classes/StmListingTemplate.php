...
class StmListingTemplate {
	 ...
	 * @return string
	 */
	public static function locate_template($template_name, $template_path = 'ulisting/', $default_path = '') {
		$template_name .= '.php';
	 ...
	 * @return bool|string
	 */
	public static function load($template_name, $args = array(), $template_path = 'ulisting/', $default_path = ''){
		ob_start();
		if(is_array($args))
			extract( $args );
	...
	public static function template_path() {
		 return apply_filters( 'ulisting_template_path', 'ulisting/' );
	}
	...
	public static function plugin_path($default_path = '') {
		...
		return untrailingslashit(ULISTING_PATH.'/templates/');
	}
}