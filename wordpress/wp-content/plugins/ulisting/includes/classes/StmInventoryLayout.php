...
class StmInventoryLayout{
	...
	public static function uListing_inventory_page_data() {
        ...
        if ( current_user_can('manage_options') ) {
            ...
            $layout_id = isset( $_GET['layout_id'] ) ? $_GET['layout_id'] : null;
	...
	public static function get_layout_delete() {
		...
		if ( current_user_can('manage_options') && isset($_POST['id']) AND $layout = get_option($_POST['id']) ){
			delete_option(sanitize_text_field($_POST['id']));
