 ...
 */
?>
<div id="ulisting-feedback-modal" class="ulisting-feedback-modal" style="display: none">
	<div class="feedback-modal-content">
		<span class="feedback-modal-close">&times;</span>
		<span class="feedback-thank-you" style="display: none;">
			<img src="<?php echo esc_url(ULISTING_URL . '/assets/img/feedback/thank-you.svg') ?>">
		</span>
		...
		<div class="feedback-extra">
			...
			<small>Found a bug in the plugin? <a href="<?php echo esc_url( $ticket_url ); ?>" target="_blank">Click here</a> to report it.</small>
		</div>
		<a href="https://bit.ly/2RQjcEQ" class="feedback-submit" target="_blank">
			Submit
			<img src="<?php echo esc_url(ULISTING_URL . '/assets/img/feedback/external-link.svg') ?>">
		</a>
	</div>
</div>