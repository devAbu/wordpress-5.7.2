    ...
    class Envato_Market_Admin
    {
        ...
        public function maybe_delete_transients()
        {
            if (isset($_POST[envato_market()->get_option_name()])) {
                ...
                if (isset($_POST['_wpnonce']) && !wp_verify_nonce($_POST['_wpnonce'], envato_market()->get_slug() . '-options')) {
                    wp_die(esc_html__('You do not have sufficient permissions to delete transients.', 'homepress'));
                }
        ...
        public function admin_enqueue_script()
        {
            ...
            $exports = array(
                ...
                'i18n' => array(
                    'save' => esc_html__('Save', 'homepress'),
                    'remove' => esc_html__('Remove', 'homepress'),
                    'cancel' => esc_html__('Cancel', 'homepress'),
                    'error' => esc_html__('An unknown error occurred. Try again.', 'homepress'),
                ),
            );
        ...
        public function render_templates()
        {
            ...
            <script type="text/html" id="tmpl-envato-market-auth-check-button">
                <a href="<?php echo esc_url(add_query_arg(array('authorization' => 'check'), envato_market()->get_page_url())); ?>"
                   ...
                   style="margin:0 5px"><?php esc_html_e('Test API Connection', 'homepress'); ?></a>
            </script>

            <script type="text/html" id="tmpl-envato-market-item">
                <li data-id="{{ data.id }}">
                    <span class="item-name"><?php esc_html_e('ID', 'homepress'); ?>
                        : {{ data.id }} - {{ data.name }}</span>
                    <button class="item-delete dashicons dashicons-dismiss">
                        <span class="screen-reader-text"><?php esc_html_e('Delete', 'homepress') ?></span>
                    </button>
                    <input type="hidden"
            ...
            <script type="text/html" id="tmpl-envato-market-dialog-remove">
                <div id="envato-market-dialog-remove" title="<?php esc_attr_e('Remove Item', 'homepress') ?>">
                    <p><?php esc_html_e('You are about to remove the connection between the Envato Market API and this item. You cannot undo this action.', 'homepress') ?></p>
                </div>
            </script>

            <script type="text/html" id="tmpl-envato-market-dialog-form">
                <div id="envato-market-dialog-form" title="<?php esc_attr_e('Add Item', 'homepress') ?>">
                    <form>
                        <fieldset>
                            <label for="token"><?php esc_html_e('Token', 'homepress') ?></label>
                            <input type="text" name="token" class="widefat" value=""/>
                            <p class="description"><?php esc_html_e('Enter the Envato API Personal Token.', 'homepress'); ?></p>
                            <label for="id"><?php esc_html_e('Item ID', 'homepress') ?></label>
                            <input type="text" name="id" class="widefat" value=""/>
                            <p class="description"><?php esc_html_e('Enter the Envato Item ID.', 'homepress'); ?></p>
                        ...
                        <div class="envato-card-top">
                            ...
                            <div class="column-name">
                                <h4>
                                    ...
                                    <span class="version"
                                          aria-label="<?php esc_attr_e('Version %s', 'homepress'); ?>"><?php esc_html_e('Version', 'homepress'); ?>
                                        {{ data.version }}</span>
                                </h4>
                            </div>
                            <div class="column-description">
                                ...
                                <p class="author">
                                    <cite><?php esc_html_e('By', 'homepress'); ?> {{ data.author }}</cite>
                                </p>
                            </div>
                        </div>
                        <div class="envato-card-bottom">
                            <div class="column-actions">
                                <a href="{{{ data.install }}}" class="button button-primary">
                                    <span aria-hidden="true"><?php esc_html_e('Install', 'homepress'); ?></span>
                                    <span class="screen-reader-text"><?php esc_html_e('Install', 'homepress'); ?> {{ data.name }}</span>
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        public function register_settings()
        {
            ...
            add_settings_section(
                ...
                esc_html__('Global OAuth Personal Token', 'homepress'),
            ...
            add_settings_section(
                ...
                esc_html__('Single Use OAuth Personal Tokens', 'homepress'),
            ...
            add_settings_field(
                'items',
                esc_html__('Envato Market Items', 'homepress'),
        ...
        public function install_plugin($plugin)
        {
            if (!current_user_can('install_plugins')) {
                $msg = '
				<div class="wrap">
					<h1>' . esc_html__('Installing Plugin...', 'homepress') . '</h1>
					<p>' . esc_html__('You do not have sufficient permissions to install plugins on this site.', 'homepress') . '</p>
					<a href="' . esc_url('admin.php?page=' . envato_market()->get_slug() . '&tab=plugins') . '">' . esc_html__('Return to Plugin Installer', 'homepress') . '</a>
				</div>';
                wp_die($msg);
            }
            ...
            if (empty($array_api)) {
				...
				<div class="wrap">
					<h1>' . esc_html__('Installing Plugin...', 'homepress') . '</h1>
					<p>' . esc_html__('An error occurred, please check that the item ID is correct.', 'homepress') . '</p>
					<a href="' . esc_url('admin.php?page=' . envato_market()->get_slug() . '&tab=plugins') . '">' . esc_html__('Return to Plugin Installer', 'homepress') . '</a>
				</div>';
                wp_die($msg);
            }

            $title = sprintf(esc_html__('Installing Plugin: %s', 'homepress'), $api->name . ' ' . $api->version);
        ...
        public function install_theme($theme)
        {
            if (!current_user_can('install_themes')) {
                $msg = '
				<div class="wrap">
					<h1>' . esc_html__('Installing Theme...', 'homepress') . '</h1>
					<p>' . esc_html__('You do not have sufficient permissions to install themes on this site.', 'homepress') . '</p>
					<a href="' . esc_url('admin.php?page=' . envato_market()->get_slug() . '&tab=themes') . '">' . esc_html__('Return to Theme Installer', 'homepress') . '</a>
				</div>';
                wp_die($msg);
            }
            ...
            if (empty($array_api)) {
				...
				<div class="wrap">
					<h1>' . esc_html__('Installing Theme...', 'homepress') . '</h1>
					<p>' . esc_html__('An error occurred, please check that the item ID is correct.', 'homepress') . '</p>
					<a href="' . esc_url('admin.php?page=' . envato_market()->get_slug() . '&tab=themes') . '">' . esc_html__('Return to Plugin Installer', 'homepress') . '</a>
				</div>';
                wp_die($msg);
            }
            ...
            $title = sprintf(esc_html__('Installing Theme: %s', 'homepress'), $api->name . ' ' . $api->version);
        ...
        public function ajax_upgrade_theme()
        {
            ...
            if ($theme_data->exists() && $theme_data->get('Version')) {
                $status['oldVersion'] = sprintf(esc_html__('Version %s', 'homepress'), $theme_data->get('Version'));
            }

            if (!current_user_can('update_themes')) {
                $status['error'] = esc_html__('You do not have sufficient permissions to update themes for this site.', 'homepress');
            ...
            if (is_array($result) && !empty($result[$theme])) {
                ...
                if ($theme_data->exists() && $theme_data->get('Version')) {
                    $status['newVersion'] = sprintf(esc_html__('Version %s', 'homepress'), $theme_data->get('Version'));
                }
                ...
                $status['error'] = esc_html__('Unable to connect to the filesystem. Please confirm your credentials.', 'homepress');
        ...
        public function ajax_add_item()
        {
            if (!check_ajax_referer(self::AJAX_ACTION, 'nonce', false)) {
                ...
                wp_send_json_error(array('message' => esc_html__('The Token is missing.', 'homepress')));
            } elseif (empty($_POST['id'])) {
                wp_send_json_error(array('message' => esc_html__('The Item ID is missing.', 'homepress')));
            }
            ...
            if (false === $request) {
                wp_send_json_error(array('message' => esc_html__('The Token or Item ID is incorrect.', 'homepress')));
            }

            if (false === envato_market()->api()->download($_POST['id'], $args)) {
                wp_send_json_error(array('message' => esc_html__('The item cannot be downloaded.', 'homepress')));
            }
            ...
            wp_send_json_error(array('message' => esc_html__('An unknown error occurred.', 'homepress')));
        }
        ...
        public function homepress_require_file($path)
        {
        ...
        {
            $this->homepress_require_file('inc/admin/view/callback/admin.php');
        }
        ...
        {
            $this->homepress_require_file('inc/admin/view/callback/section/oauth.php');
        }
        ...
        {
            $this->homepress_require_file('inc/admin/view/callback/section/items.php');
        }
        ...
        {
            $this->homepress_require_file('inc/admin/view/callback/setting/token.php');
        }
        ...
        {
            $this->homepress_require_file('inc/admin/view/callback/setting/items.php');
        }
        ...
        {
            $this->homepress_require_file('inc/admin/view/partials/intro.php');
        }
        ...
        {
            $this->homepress_require_file('inc/admin/view/partials/tabs.php');
        }
        ...
        {
            $this->homepress_require_file('inc/admin/view/partials/settings.php');
        }
        ...
        {
            $this->homepress_require_file('inc/admin/view/partials/themes.php');
        }
        ...
        {
            $this->homepress_require_file('inc/admin/view/partials/plugins.php');
        }
        ...
        {
            $this->homepress_require_file('inc/admin/view/notice/success.php');
        }
        ...
        {
            $this->homepress_require_file('inc/admin/view/notice/success-no-items.php');
        }
        ...
        {
            $this->homepress_require_file('inc/admin/view/notice/success-single-use.php');
        }
        ...
        {
            $this->homepress_require_file('inc/admin/view/notice/error.php');
        }
        ...
        {
            $this->homepress_require_file('inc/admin/view/notice/error-single-use.php');
        }
    }
