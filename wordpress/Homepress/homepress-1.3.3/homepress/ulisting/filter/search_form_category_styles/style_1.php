...
<?php endforeach; ?>
    ...
    <div id="stm_search_form_category_<?php echo esc_attr( $id ); ?>"
         class="ulisting-search_box ulisting-search_box_<?php echo esc_attr( $params[ 'style' ] ); ?>">
            ...
            <div>
                <ul class="nav nav-tabs">
                    ...
                    foreach ( $categories as $category ): if( $i == 0 ) $data[ 'active_tab' ] = $category->term_id; ?>
                        <li class="nav-item" data-v-bind_class="{ tab_active: active_tab == <?php echo esc_attr( $category->term_id ); ?>}">
                            <a class="nav-link stm-cursor-pointer"
                               data-v-bind_class="{ active: active_tab == <?php echo esc_attr( $category->term_id ); ?>}"
                               data-v-on_click="set_active_tab(<?php echo esc_attr( $category->term_id ); ?>)"><span><?php echo esc_attr( $category->name ); ?></span></a>
                        </li>
                        <?php $i++; endforeach; ?>
                </ul>
                ...
                <div class="tab-content">
                    <?php foreach ( $categories as $k => $category ) : ?>
                        <div data-v-if="active_tab == <?php echo esc_attr( $category->term_id ); ?>"
                             data-v-bind_class="{'show active':active_tab == <?php echo esc_attr( $category->term_id ); ?>}"
                             class="tab-panel fade <?php if( is_admin() ) {
                            ...
                            <?php else: ?>
                            <div class="row homepress_loading_preloader preloader_show">
                                    ...
                                    <?php foreach ( $listing_type_form as $key => $form ) :
                                        ...
                                        if( $index == 0 )
                                            $class = "col-xl-6 col-lg-5 col-md-6 col-sm-12";
                                        ...
                                        if( $index == 0 ) {
                                            ...
                                            $form_content .= '<div data-v-if="category_selected.type_selected == ' . $key . '" class="col-xl-2 col-lg-2 col-md-3 col-sm-12">
                                                                        <a data-v-bind_href="category_selected.url" class="homepress-button homepress-button-full icon-left" ><span class="button-icon property-icon-search"></span>' . __( "Search", "homepress" ) . '</a>
                                                                  </div>';

                                            $form_content .= '<div data-v-if="category_selected.type_selected == ' . $key . '" class="col-xl-1 col-lg-2 col-md-12 col-sm-12">
                                                                           
                                                                    <div class="advanced-search-button" 
                                                                         data-v-bind_class="{open:categories[' . $category->term_id . '].advanced_panel_show}"
