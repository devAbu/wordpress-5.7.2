        ...
        <a href="<?php echo get_author_posts_url( $user->ID ); ?>">
            ...
            <span class="profile-avatar-info">
                <?php if( !empty( $user->phone_mobile ) ) { ?>
                    <span class="phone"><?php esc_html_e( 'Call:', 'homepress' ); ?> <?php echo esc_attr( $user->phone_mobile ); ?></span>
                <?php } ?>
                <?php if( !empty( $user->user_firstname ) ) { ?>
                    <span class="user-info <?php if( $user->verified_user == 'yes' ) { ?>verified_user<?php } ?>"><span class="property-icon-shield verified-profile-icon"></span> <?php echo esc_attr( $user->user_firstname ); ?> <?php echo esc_attr( $user->user_lastname ); ?></span>
                <?php } ?>
            </span>
        </a>
    </div>
