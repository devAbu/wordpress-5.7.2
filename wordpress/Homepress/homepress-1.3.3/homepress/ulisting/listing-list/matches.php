...
$matches =  '<div '.\uListing\Classes\Builder\UListingBuilder::generation_html_attribute($element).'><span class="ulisting-matches-count">'. '{{matches}}</span> <span class="ulisting-matcher-text">'. $title . '</span></div>';
