...
class STMT_Metaboxes
{
    ...
    function boxes()
    {
        return apply_filters('theme_options', array(
            ...
            'pages_fields' => array(
                'post_type' => array('page', 'post', 'stmt-services', 'listing'),
    ...
    function stmt_to_scripts($hook)
    {
        ...
        wp_enqueue_script('sortable', $base . 'js/sortable.min.js', array('vue.js'), $v);
        wp_enqueue_script('vue-draggable', $base . 'js/vue-draggable.min.js', array('sortable.js'), $v);
