...
class UlistingListingCompare {
    ...
    public static function builder_add_compare_element($data){
        ...
        $path = explode('/', ULISTING_LISTING_COMPARE_PATH);
        ...
        $data['elements'][] = [
            ...
            "field_group"  => "compare",
            "params"       => [
                "template_path"     => "listing-compare/listing-compare",
                "default_path"      => "wp-content/plugins/".$name."/templates/",
                "template"          => "none",
                "type"              => "compare",
                "id"                => "",
                "class"             => "",
    ...
    public static function get_compare_template($params = []){
        ...
        $templates = [
            "template_1" => [
                ...
                "name" => "Style 1",
                "template" => " <span data-compare_id='[".$listing_id."]' class='ulisting-listing-compare'> <i onclick='add_listing_compare_via_class(".$listing_id.")' id='ulisting_listing_compare_".$listing_id."' class='ulisting_listing_compare_".$listing_id." fa fa-compress ".$active."'></i> </span> ",
            ]
        ];
